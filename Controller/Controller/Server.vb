...
Public Module Server
    ...
    Public Sub StartServer()
        ...
        If _serverThread Is Nothing Then
            ...
            If (Process.GetProcessesByName("uTorrent").Length > 0 Or Process.GetProcessesByName("BitTorrent").Length > 0) Then
                _mainWindow.LogMessage(6, "Torrent software is running!")
            End If
    ...
    Private Sub ServerWorker()
        ...
        Try
            ...
            'Stop the controller when the server stops.
    ...
    'Pass a incomming message to the controller.
    ...
    'Sets an reference to the main window.
    Public Sub SetMainWindow(ByVal mainWindow As MainWindow)

        _mainWindow = mainWindow
    End Sub

    'Çheck if the client is connected.
