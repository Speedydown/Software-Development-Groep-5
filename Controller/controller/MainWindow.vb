...
Public Class MainWindow
    ...
    Private Sub MainWindow_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        LogMessage(1, "Controller Build 110520151040.")
    ...
    Public Sub LogMessage(ByVal type As Integer, ByVal message As String)
        ...
        'Add a (log) message to the main window.
    ...
    Private Function CheckServerReady() As Boolean
        ...
        MessageBox.Show("Cannot perform this action. Please verify that the sever is started and the simulator is connected, and try again.", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
    ...
    Private Sub ToolStripButtonLaunchTest_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ToolStripButtonLaunchTest.Click
        If CheckServerReady() Then
    ...
    Private Sub ButtonVehicleAnnouncementReceive_Click(sender As Object, e As EventArgs) Handles ButtonVehicleAnnouncementReceive.Click
        ...
        If CheckServerReady() Then
            Dim message As Message = New Message(3, parameters)
            ...
            Invoke(Sub()
                       ...
                       Else
                           If value IsNot Nothing Then
                               LabelTimersCurrentTimerValue.Text = value
                           Else
                               LabelTimersCurrentTimerValue.Text = "N/A"
                           End If
